...
import 'package:cash_book/waiting%20code/api_verify_code.dart';
        ...
        Padding(
          ...
          child: RoundedSubmitButtonWidget(
            ...
            onPressed: () {
              ...
              // $ await apiVerifyCode(Get.find<TempUserController>().tempUser.value!.userPhoneNumber, Get.find<VerificationCodeTextFieldController>().verificationCode!.text) ? getUserToHomeScreen(currentUser) : const SnackBar(content: Text('wrong code'));
